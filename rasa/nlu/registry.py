...
from rasa.nlu.tokenizers.pyvi_tokenizer import PyViVietnameseTokenizer
from rasa.nlu.tokenizers.vncorenlp_tokenizer import VncoreNLPVietnameseTokenizer
...
component_classes = [
    ...
    PyViVietnameseTokenizer,
    VncoreNLPVietnameseTokenizer,
    VietnameseTokenizer,
    # extractors
